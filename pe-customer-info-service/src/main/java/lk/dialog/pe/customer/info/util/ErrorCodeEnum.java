...
public enum ErrorCodeEnum {
	...
	ERR_DESC_500_INVALID_SCENARIO("ERR_DESC_500_INVALID_SCENARIO"),
	ERR_DESC_CUSTOMER_REF_TYPE ("Customer ref type can not be null, when customer ref not null."),
	ERR_CODE_CUSTOMER_REF_TYPE("Invalid customer ref type.");
