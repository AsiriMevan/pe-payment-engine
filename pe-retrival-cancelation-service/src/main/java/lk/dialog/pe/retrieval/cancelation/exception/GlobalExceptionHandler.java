...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<BaseResponse> exceptionHandler(Exception ex, WebRequest request) {
		...
		error.setErrorDesc(ex.toString());
	...
	@ExceptionHandler(QuerySystemException.class)
	public ResponseEntity<BaseResponse> querySystemexceptionHandler(Exception ex, WebRequest request) {
