...
@SpringBootApplication(scanBasePackages = {"lk.dialog.pe.credit.cam","lk.dialog.pe.billing","lk.dialog.pe.common"})
@PropertySource("classpath:/cam-application.properties")
@PropertySource("classpath:/cam-api-urls.properties")

@EnableSwagger2
public class PeBillingServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(PeBillingServiceApplication.class, args);
	}
