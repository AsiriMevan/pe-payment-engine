...
@EnableSwagger2
public class PeCcbsDbIntServiceApplication {

	@Bean
	public Docket swaggerConfiguration() {
		// Prepare and return a Docket instance
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("lk.dialog.pe.persistence.api")).build().apiInfo(getApiDetails());
	}
	...
	public static void main(String[] args) {
		SpringApplication.run(PeCcbsDbIntServiceApplication.class, args);
	}
