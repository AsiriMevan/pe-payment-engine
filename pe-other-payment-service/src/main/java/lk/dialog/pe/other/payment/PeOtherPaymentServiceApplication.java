package lk.dialog.pe.other.payment;
...
@EnableSwagger2
public class PeOtherPaymentServiceApplication {

	@Value("${dcpe.default.timeZone}")
	public String timeZone;
	
	public static void main(String[] args) {
		SpringApplication.run(PeOtherPaymentServiceApplication.class, args);
	}
	...
	public Docket swaggerConfiguration() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("lk.dialog.pe.other.payment.api")).build().apiInfo(getApiDetails());
	}
