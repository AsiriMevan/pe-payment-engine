...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<DCPEResponse> exceptionHandler(Exception ex, WebRequest request) {
		...
		if(errorMsg.contains("java.sql.SQLSyntaxErrorException: ORA-01722: invalid number\n")) {
			errorMsg = "java.sql.SQLSyntaxErrorException: ORA-01722: invalid number\n";
		}
		dcpeResponse.setMessage(errorMsg);
