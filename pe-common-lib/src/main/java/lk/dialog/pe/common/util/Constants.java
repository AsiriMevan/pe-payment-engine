...
public class Constants {
	...
	public static final String ERR_DESC_SUCCESS = "API call successful";
	...
	public static final String PHYSICAL_PAY_DATE_NOT_FOUND="#: required key [physicalPaymentDate] not found";
	public static final String RECEIPT_DATE_NOT_FOUND="#: required key [receiptDate] not found";
	public static final String RECEIPTS_INFO_RECEIPT_DATE= "#/receiptsInfo/0: required key [receiptDate] not found";
}
