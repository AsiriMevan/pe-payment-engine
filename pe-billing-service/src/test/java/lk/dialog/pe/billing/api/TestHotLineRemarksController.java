...
public class TestHotLineRemarksController {

    @Autowired
    private MockMvc mvc;

    @Test
    public void getHotlineRemarks() throws Exception {
        String payload = RequestPayloadUtil.getJsonString(PayloadPath.GET_HOTLINE_REMARKS);
