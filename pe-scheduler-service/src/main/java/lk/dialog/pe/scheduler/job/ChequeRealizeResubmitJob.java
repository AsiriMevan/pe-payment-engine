...
@Slf4j
public class ChequeRealizeResubmitJob  implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        HANDLER handler = HANDLER.CHEQUE_FORCEFUL_PAY_RETRY;
        ...
        jobExecutorService.submitForceFulCheckRealizeFailHandler(traceId);
